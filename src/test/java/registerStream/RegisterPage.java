...
public class RegisterPage extends BasicWrap {
	...
	By locator_register = By.linkText("Reg�strate");
	...
	String password = "@Password13";// contrase�a y confirmaci�n de contrase�a
	String identification = "900584789";// Numero de identificaci�n o Nit 900584789
	String DV = "8";// digito de verificaci�n obligatorio si el tipo de documento es NIT
